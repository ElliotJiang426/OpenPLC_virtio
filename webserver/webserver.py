...
def hardware():
    if (flask_login.current_user.is_authenticated == False):
        ...
        if (flask.request.method == 'GET'):
            ...
            if (current_driver == "rpi"): return_str += "<option selected='selected' value='rpi_1'>Raspberry Pi 1</option><option value='rpi_2'>Raspberry Pi 2</option><option value='rpi_3'>Raspberry Pi 3</option>"
            else: return_str += "<option value='rpi_1'>Raspberry Pi 1</option><option value='rpi_2'>Raspberry Pi 2</option><option value='rpi_3'>Raspberry Pi 3</option>"
